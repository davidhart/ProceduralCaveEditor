...
void TestApp::CreateLightingPage()
{
	...
	Gwen::Controls::ListBox* lightingList = new Gwen::Controls::ListBox(s);
	lightingList->SetBounds(0,0, 116, 106);
	lightingList->AddItem(L"Spot 1");
	lightingList->AddItem(L"Spot 2");
	lightingList->AddItem(L"Point 1");
	lightingList->AddItem(L"Spot 3");
	lightingList->AddItem(L"Point 2");
